...
$smarty->assign('formstart',
		$this->CGCreateFormStart($id,'admin_setadminemail_prefs',
					 $returnid));
...
$smarty->assign('input_email_subject',
		$this->CreateInputText($id,'email_subject',
				       $this->GetPreference('adminemail_subject'),100,255));
$smarty->assign('prompt_email_subject',$this->Lang('email_subject'));

echo $this->ProcessTemplate('adminemail_tab.tpl');

$this->EditDefaultTemplateForm($this,$id,$returnid,'adminemail_template',
			       'adminemail',
			       $this->Lang('title_adminemail_template'),
			       'orig_adminemail_template.tpl',
			       $this->Lang('info_adminemail_template'),
			       'admin_templates');
