...
$tmp = $this->GetSingleTemplateForm($this,$id,$returnid,
				    $report_name,
				    'report_templates',
				    $this->Lang('edit_report_template',$this->Lang($report_name)),
				    'orig_'.$report_name.'.tpl',
				    $this->Lang('info_edit_report_template'),
				    'admin_templates');
echo $tmp;
