...
{$formstart}
<div class="c_full cf">
  <label class="grid_3">{$Orders->Lang('prompt_address_retrieval')}</label>
...
{if isset($properties)}
<hr/>
<h4>{$Orders->Lang('prompt_address_property_map')}:</h4>

<div class="c_full cf">
  <label class="grid_3">{$Orders->Lang('company')}:</label>
...
<div class="c_full cf">
  <label class="grid_3">{$Orders->Lang('first_name')}:</label>
...
<div class="c_full cf">
  <label class="grid_3">{$Orders->Lang('last_name')}:</label>
...
<div class="c_full cf">
  <label class="grid_3">{$Orders->Lang('address1')}:</label>
...
<div class="c_full cf">
  <label class="grid_3">{$Orders->Lang('address2')}:</label>
...
<div class="c_full cf">
  <label class="grid_3">{$Orders->Lang('city')}:</label>
...
<div class="c_full cf">
  <label class="grid_3">{$Orders->Lang('state/province')}:</label>
...
<div class="c_full cf">
  <label class="grid_3">{$Orders->Lang('postal')}:</label>
...
<div class="c_full cf">
  <label class="grid_3">{$Orders->Lang('country')}:</label>
...
<div class="c_full cf">
  <label class="grid_3">{$Orders->Lang('phone')}:</label>
...
<div class="c_full cf">
  <label class="grid_3">{$Orders->Lang('fax')}:</label>
...
<div class="c_full cf">
  <label class="grid_3">{$Orders->Lang('email')}:</label>
...
<hr/>
<div class="c_full cf">
  <input type="submit" name="{$actionid}submit" value="{$Orders->Lang('submit')}"/>
</div>
