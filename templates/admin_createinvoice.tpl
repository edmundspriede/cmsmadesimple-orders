<h3>{$Orders->Lang('create_invoice_for',$ordernum)}</h3>
...
<div class="pageoverflow">
  <p class="pagetext">{$Orders->Lang('select_invoice_template')}:</p>
  <p class="pagetext">
...
<div class="pageoverflow">
  <p class="pagetext">{$Orders->Lang('select_action')}:</p>
  <p class="pagetext">
...
<div class="pageoverflow">
  <p class="pagetext">&nbsp;</p>
  <p class="pageinput"><input type="submit" value="{$Orders->Lang('submit')}" onclick="submit_clicked(this); return false;"/>{$cancel}</p>
</div>
{$formend}