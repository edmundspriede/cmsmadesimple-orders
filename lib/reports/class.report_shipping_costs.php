...
class report_shipping_costs extends \Orders\report_base
{
  ...
  {
    $query = 'SELECT oi.*,os.*,oo.invoice,oo.create_date FROM '.cms_db_prefix().'module_orders_items oi
               ...
               WHERE oo.status != \'proposed\'
                 ...
                 AND oo.status != \'hold\'
                 AND oi.item_type = \''.\Orders\LineItem::ITEMTYPE_SHIPPING.'\'
